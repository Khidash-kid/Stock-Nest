...
function Hero() {
    return ( 
        <div className='container '>
            <div className='row p-5 text-center mb-5 mt-5'>
                <h1 className='fs-3'>We pioneered the discount broking model in India <br/>Now ,we are breaking ground with out technology</h1>
            </div>
            <div className='row border-top border-bottom p-5 mt-5 text-muted 'style={{lineHeight:'1.8',fontSize:'1.1em'}}>
